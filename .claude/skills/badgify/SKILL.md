---
name: badgify-winner-picker
description: Picks random winners from lists, spreadsheets, raffles, and contests. Ensures fair, unbiased selection with transparency.
---

# Badgify Winner Picker

This skill randomly selects winners from lists, spreadsheets for giveaways and contests.
...
2. **Multiple Sources**: Works with CSV, Excel or plain lists
...
**User**: "Pick a random row from this Sheet to select a winner for a giveaway."
